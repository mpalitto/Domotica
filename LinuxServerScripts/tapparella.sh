...
echo 'mezzomezzo' > /root/.tapparella.status
 (sleep 10; screen -S arduino433tx -X stuff "s:5EA5A1"; echo 'aperta' > /root/.tapparella.status; echo "tapparella sono aperte") &
...
echo 'mezzomezzo' > /root/.tapparella.status
(sleep 10; screen -S arduino433tx -X stuff "s:5EA551"; echo 'chiusa' > /root/.tapparella.status; echo "tapparella sono chiuse") &
